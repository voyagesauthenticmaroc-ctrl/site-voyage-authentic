            ...
            <div className="flex gap-3 mt-5">
              ...
              {site.social.linkedinUrl && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-9 h-9 flex items-center justify-center bg-white/8 hover:bg-[#0A66C2]/25 rounded-full transition-colors border border-white/10 hover:border-[#0A66C2]/40"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" aria-hidden="true">
