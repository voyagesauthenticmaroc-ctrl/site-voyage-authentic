        ...
        <section className="section-y bg-parchment-gradient">
          <div className="container-luxury">
            <ScrollReveal className="text-center mb-10">
              <span className="text-eyebrow-accent">{t('socialEyebrow')}</span>
              <h2 className="text-display-md mt-3">
                {t('socialTitle1')} <span className="script-accent">{t('socialTitleScript')}</span>
              </h2>
              ...
              {site.social.facebookUrl && (
                <ScrollReveal delay={0}>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-4 bg-white rounded-2xl px-7 py-5 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                    style={{ border: '1px solid var(--cream-deep)' }}
                  >
                    <span
                    ...
                    <div>
                      <p className="font-display text-lg font-semibold" style={{ color: 'var(--ink)' }}>{t('socialFacebook')}</p>
              ...
              {site.social.instagramUrl && (
                <ScrollReveal delay={100}>
                  ...
                  >
                    ...
                    <div>
                      <p className="font-display text-lg font-semibold" style={{ color: 'var(--ink)' }}>{t('socialInstagram')}</p>
              ...
              {site.social.linkedinUrl && (
                <ScrollReveal delay={200}>
                  ...
                  >
                    ...
                    <div>
                      <p className="font-display text-lg font-semibold" style={{ color: 'var(--ink)' }}>{t('socialLinkedin')}</p>
